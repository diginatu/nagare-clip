...
9. director — a larger LLM proposes high-level edits (cut/timelapse/overlay/keep/edit) as a reviewable JSON op list, and decides the playback order (fed the summary/plan overview context; the plan's order is only its starting point)
