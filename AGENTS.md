...
- Stage 4 additionally extracts `<overlay text="...">...</overlay>` ranges via
  ...
  on channel 4 (one above the caption channel, which is ch3). An overlay spanning
