...
Run inside Blender:
  blender --background --python tests/blender/blender_retiming_positions.py -- <video> <output_json>
...
from nagare_clip.blender.timeline import build_timeline_map, place_strips
