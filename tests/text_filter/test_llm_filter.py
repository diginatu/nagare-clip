"""Tests for text_filter LLM filter."""
...
from nagare_clip.text_filter.llm_filter import (
    _apply_patches,
    _batch_lines,
    _format_batch,
    _parse_response,
...
class TestFilterTranscript:
    ...
    @patch("nagare_clip.text_filter.llm_filter._call_llm")
...
_FILTER_LOGGER = "nagare_clip.text_filter.llm_filter"
